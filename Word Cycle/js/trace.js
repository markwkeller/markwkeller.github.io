...
var rand = content[Math.floor(Math.random()*content.length)];
document.getElementById("change").style.color=randomColor();
  document.getElementById('change').innerHTML = rand;

}

window.onload=function startFunction() { change();  stopAction = setInterval(change, 1000); }
